...
@section('title', 'Fasilitas Pesantren — PPMU')
...
<div class="fasilitas-hero">
    <div class="container">
        <div class="text-center">
            ...
            <h1 class="display-5 fw-bold text-white mb-3">Fasilitas Pesantren</h1>
            <p class="text-light opacity-75 mb-0" style="max-width:560px;margin:auto;font-size:1rem;">
                Sarana dan prasarana lengkap yang menunjang kenyamanan ibadah dan belajar para santri di lingkungan pondok pesantren.
            </p>
        </div>
    </div>
</div>
