            ...
            <div class="bg-light rounded h-100 p-4">
                ...
                <form action="{{ route('admin.donasi.store') }}" method="POST">
                    ...
                    <div class="mb-3" id="barang_box" style="display: none;">
                        ...
                        <input type="text" name="nama_barang" id="nama_barang" class="form-control @error('nama_barang') is-invalid @enderror" value="{{ old('nama_barang') }}" placeholder="Contoh: Semen 10 Sak, Sajadah 5 Pcs">
