...
@section('title_page', 'Banner Utama (Slider)')

@section('content')
<div class="card border-0 shadow-sm rounded-4">
    <div class="card-body p-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h5 class="fw-bold mb-0">Daftar Banner</h5>
            <a href="{{ route('admin.banner.create') }}" class="btn btn-primary rounded-3 px-4 fw-semibold">
                ...
                <tbody>
                    @forelse($banners as $banner)
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('admin.banner.edit', $banner->id) }}" class="btn btn-sm btn-outline-primary rounded-3">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center py-4 text-muted">Belum ada data banner.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
